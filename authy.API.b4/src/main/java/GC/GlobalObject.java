...
public class GlobalObject {
   ...
   // private static String[] mtrunning_status = new  array();
 ...
 /*   public GlobalObject(String mtname, Object obj){
    	this.mtrunning_status[]=name;
    	
    }
    
    public String getgor(String mtname){
    	return mtrunning_status[mtname];
    }
   ...
   */ 
    ...
    public static void updateObjRef(String name, Object obj){
	//	GlobalObject(name,obj);
		System.out.println("object Ref update in Config:"+name);
    }
